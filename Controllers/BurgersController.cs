...
namespace KamilaRevelo_EjercicioCF.Controllers
{
    public class BurgersController : Controller
    {
        private readonly KamilaRevelo_EjercicioCFContext _context;

        public BurgersController(KamilaRevelo_EjercicioCFContext context)
        {
            _context = context;
        }
